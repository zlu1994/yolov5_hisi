    ...
    SVP_BLOB_S *pstDstRoi, SVP_BLOB_S *pstClassRoiNum, HI_FLOAT f32PrintResultThresh)
{
    ...
    for (i = 1; i < u32ClassNum; i++)
    {
        ...
        SAMPLE_SVP_TRACE_INFO("sample_nnie,line=%d\n", __LINE__);
        //SAMPLE_SVP_TRACE_INFO("sample_nnie,line=%d; f32Score=%f; f32PrintResultThresh=%f\n", __LINE__, (HI_FLOAT)ps32Score[u32ScoreBias] / SAMPLE_SVP_NNIE_QUANT_BASE, f32PrintResultThresh);
        ...
        for (j = 0; j < (HI_U32)ps32ClassRoiNum[i]; j++)
        {
            ...
            // SAMPLE_SVP_TRACE_INFO("sample_nnie,line=%d; f32Score=%f\n", __LINE__, f32Score);
            // SAMPLE_SVP_TRACE_INFO("sample_nnie,line=%d\n", __LINE__);
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    SAMPLE_SVP_TRACE_INFO("sample_nnie.c %d, pstSoftWareParam->u32OriImHeight=%d, pstSoftWareParam->u32OriImHeight=%d\n", __LINE__, pstSoftWareParam->u32OriImHeight, pstSoftWareParam->u32OriImHeight);
    ...
    pstSoftWareParam->au32GridNumHeight[0] = 20;
    pstSoftWareParam->au32GridNumHeight[1] = 40;
    pstSoftWareParam->au32GridNumHeight[2] = 80;
    pstSoftWareParam->au32GridNumWidth[0] = 20;
    pstSoftWareParam->au32GridNumWidth[1] = 40;
    pstSoftWareParam->au32GridNumWidth[2] = 80;
    ...
    // //fish数据集的640
    // pstSoftWareParam->af32Bias[0][0] = 182;
    // pstSoftWareParam->af32Bias[0][1] = 433;
    // pstSoftWareParam->af32Bias[0][2] = 349;
    // pstSoftWareParam->af32Bias[0][3] = 259;
    // pstSoftWareParam->af32Bias[0][4] = 396;
    // pstSoftWareParam->af32Bias[0][5] = 499;
    // pstSoftWareParam->af32Bias[1][0] = 126;
    // pstSoftWareParam->af32Bias[1][1] = 221;
    // pstSoftWareParam->af32Bias[1][2] = 80;
    // pstSoftWareParam->af32Bias[1][3] = 364;
    // pstSoftWareParam->af32Bias[1][4] = 233;
    // pstSoftWareParam->af32Bias[1][5] = 145;
    // pstSoftWareParam->af32Bias[2][0] = 48;
    // pstSoftWareParam->af32Bias[2][1] = 56;
    // pstSoftWareParam->af32Bias[2][2] = 55;
    // pstSoftWareParam->af32Bias[2][3] = 146;
    // pstSoftWareParam->af32Bias[2][4] = 129;
    // pstSoftWareParam->af32Bias[2][5] = 94;


    // //fish数据集的416
    pstSoftWareParam->af32Bias[0][0] = 118;
    pstSoftWareParam->af32Bias[0][1] = 282;
    pstSoftWareParam->af32Bias[0][2] = 227;
    pstSoftWareParam->af32Bias[0][3] = 166;
    pstSoftWareParam->af32Bias[0][4] = 257;
    pstSoftWareParam->af32Bias[0][5] = 324;
    pstSoftWareParam->af32Bias[1][0] = 82;
    pstSoftWareParam->af32Bias[1][1] = 144;
    pstSoftWareParam->af32Bias[1][2] = 52;
    pstSoftWareParam->af32Bias[1][3] = 237;
    pstSoftWareParam->af32Bias[1][4] = 151;
    pstSoftWareParam->af32Bias[1][5] = 94;
    pstSoftWareParam->af32Bias[2][0] = 32;
    pstSoftWareParam->af32Bias[2][1] = 36;
    pstSoftWareParam->af32Bias[2][2] = 36;
    pstSoftWareParam->af32Bias[2][3] = 95;
    pstSoftWareParam->af32Bias[2][4] = 84;
    pstSoftWareParam->af32Bias[2][5] = 61;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    HI_S32 s32Ret = HI_SUCCESS;
    /*init hardware para*/
    SAMPLE_SVP_TRACE_INFO("sample_nnie.c %d, pstNnieParam->pstModel->astSeg[i].astSrcNode[j].unShape.stWhc.u32Height=%d\n", __LINE__, pstNnieParam->pstModel->astSeg[0].astSrcNode[0].unShape.stWhc.u32Height);
...
{
    HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/hoser_dog_car_person_800x600.bgr";
    // HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/dog_bike_car_zhuan.bgr";
    // HI_CHAR *pcModelName = "./data/nnie_model/detection/inst_yolov3_cycle_demo.wk";
    HI_CHAR *pcModelName = "./data/nnie_model/detection/yolov5_hat_nofocus_true_inst.wk";
    ...
    /*Set configuration parameter*/
    f32PrintResultThresh = 0.5f;    //最后的阈值
    stNnieCfg.pszPic= pcSrcFile;
    stNnieCfg.u32MaxInputNum = u32PicNum; //max input image num in each batch
    stNnieCfg.u32MaxRoiNum = 0;
    stNnieCfg.aenNnieCoreId[0] = SVP_NNIE_ID_0;//set NNIE core
    ...
    SAMPLE_SVP_TRACE_INFO("sample_nnie.c %d, s_stYolov3NnieParam->pstModel->astSeg[i].astSrcNode[j].unShape.stWhc.u32Height=%d\n", __LINE__, s_stYolov3NnieParam.pstModel->astSeg[0].astSrcNode[0].unShape.stWhc.u32Height);
...
static unsigned int yolo_result_process(SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, float *strides, anchor_w_h (*anchor_grids)[3], int *map_size, yolo_result **output_result, float confidence_threshold)
{
	...
	*output_result = NULL;
    ...
    for (int yolo_layer_index = 0; yolo_layer_index < 3; yolo_layer_index ++) { // 3 yolo layer 
        ...
        // for (int i = 0; i < 400; i++) {
        //         printf("output100_show[%d]:%f \n",i,*(output_addr+i)/4096.0f);
        // }


		printf("sample_nnie,%d, feature_length=%d\n", __LINE__, feature_length);
        printf("sample_nnie,%d, output_num=%d\n", __LINE__, output_num);
        printf("sample_nnie,%d, anchor_num=%d\n", __LINE__, anchor_num);
		...
		for (int anchor_index = 0; anchor_index < anchor_num; anchor_index ++){ // 每个 grid 上有三个 anchor
				...
				for (int coord_x_y = 0; coord_x_y < feature_length; coord_x_y ++){ // feature size 拉直后的长度，如 1600 400 100.
					...
					// printf("sample_nnie,%d, anchor_num=%d\n", __LINE__, anchor_index * feature_length * output_num + 4 * feature_length + coord_x_y);
                    // printf("sample_nnie,%d, confidence=%f\n", __LINE__, confidence);
					...
					if (confidence > confidence_threshold){
						...
						for (int output_index = 5; output_index < output_num; output_index ++){
							...
							if (class_confidence > confidence_threshold){
								...
								pred_x = SAMPLE_SVP_NNIE_SIGMOID(pred_x);
								pred_y = SAMPLE_SVP_NNIE_SIGMOID(pred_y);
								pred_w = SAMPLE_SVP_NNIE_SIGMOID(pred_w);
								pred_h = SAMPLE_SVP_NNIE_SIGMOID(pred_h);
								// bbox 输出结果处理
...
void SAMPLE_SVP_NNIE_Yolov5(void)
{
    ...
    HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/fish_640/0258_bgr_640.bgr";
    HI_CHAR *pcModelName = "./data/nnie_model/detection/yolov5s_fish_nofc_up63_1018_inst.wk";
    ...
    /*Set configuration parameter*/
    f32PrintResultThresh = 0.15f;    //最后的阈值
    stNnieCfg.pszPic= pcSrcFile;
    stNnieCfg.u32MaxInputNum = u32PicNum; //max input image num in each batch
    stNnieCfg.u32MaxRoiNum = 0;
    stNnieCfg.aenNnieCoreId[0] = SVP_NNIE_ID_0;//set NNIE core
    ...
    //640对应的三个输出大小
    int map_size[3] = {80, 40, 20}; // 每个 yolo 层，feature map size 大小，与上面顺序对应
    //416对应的三个输出大小
    // int map_size[3] = {52, 26, 13}; // 每个 yolo 层，feature map size 大小，与上面顺序对应
	
    //fish的anchors
    anchor_w_h  anchor_grids[3][3] = {{{26.0f, 44.0f}, {62.0f, 26.0f}, {58.0f, 62.0f}}, // small yolo layer 层 anchor
									{{125.0f, 48.0f}, {61.0f, 118.0f}, {146.0f, 78.0f}}, // middle yolo layer 层 anchor
									{{118.0f, 188.0f}, {270.0f, 90.0f}, {305.0f, 277.0f}}}; // large yolo layer 层 anchor
    ...
    s32Ret = SAMPLE_SVP_NNIE_Cnn_ParamInit(&stNnieCfg,&s_stYolov5NnieParam,&s_stYolov5SoftwareParam);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,YOLOV5_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
...
//     /*Software process*/ // 处理输出结果，对结果进行筛选，下面才是不一样的地方，上面是固定模板 。
    unsigned int resltu_num = yolo_result_process(&s_stYolov5NnieParam, strides, anchor_grids, map_size, &output_result, 0.35); // 后处理
        SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,YOLOV5_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,yolo_result_process failed!\n");
	

	if(output_result != NULL){
		yolo_result_sort(output_result); // 输出结果排序，方便下面的 nms 处理
	    yolo_nms(output_result, 0.3); // nms
...
YOLOV5_FAIL_0:
    SAMPLE_SVP_NNIE_Yolov3_Deinit(&s_stYolov5NnieParam,&s_stYolov5SoftwareParam,&s_stYolov5Model);   //和yolov3一样，不用重复定义了
    SAMPLE_COMM_SVP_CheckSysExit();
